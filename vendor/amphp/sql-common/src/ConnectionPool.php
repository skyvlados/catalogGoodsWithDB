...
abstract class ConnectionPool implements Pool
{
    ...
    public function close()
    {
        ...
        if ($this->deferred instanceof Deferred) {
            ...
            $this->deferred = null;
            $deferred->fail(new FailureException("DataBase pool closed"));
        }
    }
        ...
        do {
            ...
            while ($this->idle->isEmpty()) {
                ...
                try {
                    ...
                    // DataBase will be pulled from $this->idle when promise is resolved.
    ...
    {
        \assert(isset($this->connections[$connection]), 'DataBase is not part of this pool');
